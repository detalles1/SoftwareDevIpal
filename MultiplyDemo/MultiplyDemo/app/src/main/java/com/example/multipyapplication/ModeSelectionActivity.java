...
public class ModeSelectionActivity extends Activity {
    ...
    private void launchTableActivityForGame() {
        Intent intent = new Intent(ModeSelectionActivity.this, TableActivity.class);
        intent.putExtra("number", selectedNumber); // Pass the selected number
        intent.putExtra("isGameMode", true);      // Indicate Game Mode
        startActivity(intent);
        finish();
    }
